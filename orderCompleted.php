<div id="wrapper">
    ...
    <div id="content">
                ...
                <table>
                    ...
                    while ($productsNumber > 0) {
                        ...
                        foreach ($conn->query($sql) as $row) {
                            ...
                            <tr>
                                <td>
                                    <img class="productImage" src="images/<?= strip_tags($row['Image']); ?>"/>
                                </td>
         ...
         $i=0;
            ...
            while ($productsNumber > 0) {
                ...
                foreach ($conn->query($sql) as $row) {
                    ...
                    array_push($email_order,'<td>');
                    array_push($email_order, htmlentities($row['Name']));
                    array_push($email_order,'</td>');
                    array_push($email_order,'<td>');
                    array_push($email_order, htmlentities($row['Price']));
                    array_push($email_order,'</td>');
                    array_push($email_order,'</tr>');
        ...
        function sendEmail($conn)
        {
            ...
            echo "<p>
                Message has been sent.You will receive in short time an email about your order.Thank you for choosing us!
                </p>";
    ...
    ?>
        ...
        <a href="http://localhost:90/project-bogdan/index.php">
            Return to main page.
        </a>
    </div>
